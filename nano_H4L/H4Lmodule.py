...
class HZZAnalysisProducer(Module):
    ...
    def analyze(self, event):
        ...
        AllPhotons = Helper.goodLoosePhotons2015(photons)
        ...
        foundZZCandidate, Z1, Z2 = util.ZZSelection(recoElectrons, recoMuons, Ele_tight_ID, Mu_tight_ID)
...
H4LModule = lambda : HZZAnalysisProducer() #(jetSelection= lambda j : j.pt > 30)